...
- Discover from a seed with <code>ffvaluation discover-sleeper-network --username &lt;username&gt;</code>; default discovery branches five user-graph hops with no user or league cap.
